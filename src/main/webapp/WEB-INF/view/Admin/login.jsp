...
<div id="login">
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <p>
            <label for="user_veryfy">验证码<br />
                <input class="input" id="user_veryfy" type="text" style="width: 150px" placeholder="请输入验证码" autocomplete="off" tabindex="1" name="veryfy" />
                <img id="code_img" src="/kaptcha.jpg" style="float: right; margin-right: 0px; width: 100px; height: 40px">
            </label>
        </p>
